    ...
    useEffect(() => {
        ...
        const loadBooks = async () => {
            try {
                ...
                const bookData = await myBooks(session.user.email);
    ...
    return (
        <>
                                ...
                                <div className="hidden lg:block overflow-x-auto">
                                    <table className="w-full">
                                        <thead className="bg-blue-50">
                                            <tr>
                                                <th className="text-left px-6 py-4 text-[#0A1F5C]">
                                                    Title
                                                </th>
                                                <th className="text-left px-6 py-4 text-[#0A1F5C]">
                                                    Category
                                                ...
                                                <th className="text-center px-6 py-4 text-[#0A1F5C]">
                                                    Actions
                                                </th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            {books.map((book) => (
                                                ...
                                                >
                                                    <td className="px-6 py-5 font-semibold text-[#0A1F5C]">
                                                        {book.title}
                                                    </td>
            ...
            <DeleteBookModal
                ...
                id={deletedId}
                onConfirm={(id) => {/* call your deleteBook action here */ }}
            />
        </>
    );
};
